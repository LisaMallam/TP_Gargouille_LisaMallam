...
//============================================================================
void ppm_write_to_file(int width, int height, u_char* data, FILE* file,char* nom_du_fichier)
{
...
void ppm_read_from_file(int *width, int *height, u_char** data, FILE* file, char* nom_du_fichier)
{
